...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let d = x1 * x2 + y1 * y2 + z1 * z2; // Modify this line to calculate this vector's magnitude.
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([x3, y3, z3]); // Modify this line to calculate cross product between other1 and other2.
