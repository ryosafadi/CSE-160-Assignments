...
function initTriangle3D() {
    ...
    const normalBufferSizeBytes = Float32Array.BYTES_PER_ELEMENT * MAX_VERTICES * 3;
    gl.bufferData(gl.ARRAY_BUFFER, normalBufferSizeBytes, gl.DYNAMIC_DRAW);
